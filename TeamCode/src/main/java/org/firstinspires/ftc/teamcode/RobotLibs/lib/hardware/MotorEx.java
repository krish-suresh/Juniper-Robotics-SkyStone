...
import org.firstinspires.ftc.teamcode.RobotLibs.lib.PSRobotConstants;
...
public class MotorEx {
    ...
    public MotorEx(PSResources resources, String motorName, double minPower, double maxPower, double defaultPower, double scaleBy, boolean exponential, boolean doDeadArea, PSEnum.MotorLoc motorLoc, double gearRatio) {
