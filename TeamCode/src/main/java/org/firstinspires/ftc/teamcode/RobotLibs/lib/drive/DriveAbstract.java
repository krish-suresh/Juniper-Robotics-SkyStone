...
import org.firstinspires.ftc.teamcode.RobotLibs.PSSettings;
...
public class DriveAbstract {

    PSResources resources;

    DriveAbstract(PSResources r){
        resources = r;
    }


    public void setMotor(PSEnum.MotorLoc location, double power, boolean direct) {
        ArrayList<MotorEx> motors = resources.storage.getDrivemotors(location);
    ...
    boolean isBusy() {
        ...
        ArrayList<MotorEx> motors = resources.storage.getDrivemotors();
        for (MotorEx motor : motors) {
