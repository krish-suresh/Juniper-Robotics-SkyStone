package org.firstinspires.ftc.teamcode.RobotLibs.lib.hardware;
...
import org.firstinspires.ftc.teamcode.RobotLibs.lib.utils.PSGeneralUtils;
...
public class ServoEx {
     ...
     */
    public ServoEx(PSResources r, String name, double totalRotation, double init, boolean goToInit) {
        resources = r;
        servoName = name;
     ...
     * @param goToInit   whether the servo should go to the init position in initialization
     */
    public ServoEx(PSResources r, String name, PSEnum.ServoTotalRotation servoModel, double init, String[] names, double[] positions, boolean goToInit) {
