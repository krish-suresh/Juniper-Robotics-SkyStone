...
import org.firstinspires.ftc.teamcode.RobotLibs.lib.hardware.ServoEx;
...
public class PSServoHandler {
     ...
     */
    public ServoEx newServo(String name, double totalRotation, double init, boolean goToInit) {
        return new ServoEx(resources,name,totalRotation,init,goToInit);
    }
    /**
     ...
     * @param goToInit whether the servo should be set to the init after hwmap
     */
    public ServoEx newServo(String name, PSEnum.ServoTotalRotation servoTotalRotation, double init, boolean goToInit) {
        return new ServoEx(resources,name,servoTotalRotation.getRotation(),init,goToInit);
    }
    /**
     * PowerStacker Servo Constructor, with position storage
     *
     ...
     * @param goToInit whether the servo should be set to the init after hwmap
     */
    public ServoEx newServo(String name, PSEnum.ServoTotalRotation servoTotalRotation, double init, String[] names, double[] poses, boolean goToInit) {
        return new ServoEx(resources,name,servoTotalRotation,init,names, poses,goToInit);
    }
